...
export default function Example({isOpen , onClose , user}) {
  ...
  const [formData, setFormData] = useState({
    ...
    projectIds: [] // Array to store multiple project IDs
  });
  ...
  const handleAddProjectId = () => {
    setFormData(prevState => ({
      ...prevState,
      projectIds: [...prevState.projectIds, ''] // Add an empty string for a new project ID
    }));
  };
