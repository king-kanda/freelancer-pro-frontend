...
const Page = () => {
    ...
    const handleSelectClient = (clientId) => {
        ...
        setFormData({ ...formData, clientID: clientId });  // Update clientID in formData
    };
            ...
            <div className="mx-12 mt-12 grid grid-cols-3 gap-6">
                <div className="col-span-1 col-form-details">
                    ...
                    <div className="grid grid-cols-2 gap-4 mb-3">
                        ...
                        <ClientAutoSuggest user={user} className="bg-gray-50 border border-gray-500 text-gray-900 text-sm rounded-sm focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" onSelectClient={handleSelectClient} />
